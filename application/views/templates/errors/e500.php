...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/colors.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/components.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/themes/dark-layout.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/themes/semi-dark-layout.css">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/core/menu/menu-types/horizontal-menu.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="{base_url}public/css/pages/error.css">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="hover" data-menu="horizontal-menu" data-col="1-column">
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="{base_url}public/images/pages/500.png" class="img-fluid align-self-center" alt="branding logo">
    ...
    <script src="{base_url}public/vendors/js/ui/jquery.sticky.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="{base_url}public/js/core/app-menu.js"></script>
    <script src="{base_url}public/js/core/app.js"></script>
    <script src="{base_url}public/js/scripts/components.js"></script>
    <!-- END: Theme JS-->
