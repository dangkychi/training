...
/*=========================================================================================
    ...
    Description: Record Outbound Table
    --------------------------------------------------------------------------------------
...
$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource: {
            transport: {
                read: {
                    url: base_url + "record/outbound/lists",
        ...
        columns: [{
            ...
            command: [{
                ...
                click(e) {
                    ...
                    let tr = $(e.target).closest("tr");
                    let formData = this.dataItem(tr);
                    window.top.location = base_url + 'record/outbound/download?u=' + formData.uniqueid + '&c=' + formData.customer_code;
                }
            }],
            title: "&nbsp;",
            width: 150
    ...
    $("#search").click(function () {
        ...
        let starttime = $('#from').val() ? new Date($('#from').val()) : new Date(),
            ...
            did_number = $("#did_number").val(), carrier = [];
