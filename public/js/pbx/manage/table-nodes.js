...
function activeSidebar() {
    ...
    $("#frmSubmit").on("click", function () {
        ...
        let data = $("#frm_node").serializeObject(),
            url = base_url + (typeof data.id === "undefined" ? "manage/nodes/add" : "manage/nodes/update");
...
$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource: {
            transport: {
                read: {
                    url: base_url + "manage/nodes/lists",
        ...
        columns: [{
            ...
            field: "localnode",
            title: controlsKendo.grid.column.title.localnode,
            filterable: false
        }, {
            attributes: {
                class: "table-cell",
                ...
                click(e) {
                    ...
                    $(".k-button-yes").click(function () {
                        ...
                        let csrf = $('meta[name=csrf]').attr('content').split(":"),
                            post = { [csrf[0]]: csrf[1], id: formData.id, namenode: formData.namenode };
                        $.post(base_url + "manage/nodes/destroy", post, function (response, status) {
