/*=========================================================================================
    File Name: pickupgroup.js
    Description: Pickup group Table
    --------------------------------------------------------------------------------------
...
function activeSidebar(formData = false) {
    ...
    $callgroup.select2({
        ...
        width: '100%',
        ajax: {
            url: base_url + 'settings/pickupgroup/usergroups',
            dataType: 'json',
            type: "GET",
            delay: 250,
    ...
    $("#frmSubmit").on("click", function () {
        ...
        let data = $("#frm_pickupgroup").serializeObject(),
            url = base_url + (typeof data.id === "undefined" ? "settings/pickupgroup/add" : "settings/pickupgroup/update");
...
//Open sidebar 
(function () {
    $("#add-pickupgroup").on("click", function () {
...
$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource: {
            transport: {
                read: {
                    url: base_url + "settings/pickupgroup/lists",
            ...
            command: [{
                ...
                click(e) {
                    ...
                    $(".k-button-yes").click(function () {
                        ...
                        $.post(base_url + "settings/pickupgroup/destroy", post, function (response, status) {
