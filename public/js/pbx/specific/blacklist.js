...
function activeSidebar(data = false) {
    ...
    $("#frmSubmit").on("click", function () {
        ...
        let data = $("#frm_blacklist").serializeObject(),
            url = base_url + (typeof data.id === "undefined" ? "specific/blacklist/add" : "specific/blacklist/update");
...
$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource: {
            transport: {
                read: {
                    url: base_url + "specific/blacklist/lists",
        ...
        columns: [{
            ...
            field: "creday",
            title: controlsKendo.grid.column.title.creday,
            width: 170,
            filterable: false,
            headerAttributes: {
                "class": "table-header-cell",
            ...
            command: [{
                ...
                click(e) {
                    ...
                    $(".k-button-yes").click(function () {
                        ...
                        $.post(base_url + "specific/blacklist/destroy", post, function (response, status) {
