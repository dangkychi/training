...
function activeSidebar(data = false) {
    ...
    $("#frmSubmit").on("click", function () {
        ...
        let data = $("#frm_dnc").serializeObject(),
            url = base_url + (typeof data.id === "undefined" ? "specific/dnc/add" : "specific/dnc/update");
...
$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource: {
            transport: {
                read: {
                    url: base_url + "specific/dnc/lists",
            ...
            command: [{
                ...
                click(e) {
                    ...
                    $(".k-button-yes").click(function () {
                        ...
                        $.post(base_url + "specific/dnc/destroy", post, function (response, status) {
